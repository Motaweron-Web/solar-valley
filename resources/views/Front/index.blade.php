              ...
              <div class="project-panel-holder">
                ...
                <div class="project-content">
                  <div class="project-title">
                    <h4>
                      <a href="shop-single.html"
                        >YASKAWA Japanese Pump Drives</a
                      >
                    </h4>
                  </div>
                  <!-- <div class="project-cat">
              ...
              <div class="img-hotspot img-hotspot-2">
                <div class="img-hotspot-wrap">
                  <div class="img-hotspot-bg">
                    <img
                      src="{{ asset('assets/front') }}/assets/images/background/world-map.png"
                      alt="image"
                    />
                  </div>
                  <div class="img-hotspot-pointers">
                    ...
                    >
                      <img
                        src="{{ asset('assets/front') }}/assets/images/testimonial/thumbs/1.jpg"
                        alt="pointer"
                      />
                      <div
                        class="info right"
                    ...
                    >
                      <img
                        src="{{ asset('assets/front') }}/assets/images/testimonial/thumbs/2.jpg"
                        alt="pointer"
                      />
                      <div
                        class="info right"
                    ...
                    >
                      <img
                        src="{{ asset('assets/front') }}/assets/images/testimonial/thumbs/3.jpg"
                        alt="pointer"
                      />
                      <div
                        class="info right"
                    ...
                    >
                      <img
                        src="{{ asset('assets/front') }}/assets/images/testimonial/thumbs/4.jpg"
                        alt="pointer"
                      />
                      <div
                        class="info right"
                    ...
                    >
                      <img
                        src="{{ asset('assets/front') }}/assets/images/testimonial/thumbs/5.jpg"
                        alt="pointer"
                      />
                      <div
                        class="info right"
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="cta">
                <div class="cta-img">
                  <img src="{{ asset('assets/front/') }}/assets/images/cta/1.jpg" alt="image" />
                ...
                <div class="cta-body">
                  ...
                  <div class="cta-content">
                    <p>
                      Solar power makes energy independence possible. If you
                      have any questions or need help, feel free to contact
                      (002) 01061245741.
                    </p>
                    <a
                      class="btn btn--bordered btn--white"
